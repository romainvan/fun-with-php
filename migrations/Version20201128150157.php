 ...
 */
final class Version20201128150157 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__attente AS SELECT id FROM attente');
        $this->addSql('DROP TABLE attente');
        $this->addSql('CREATE TABLE attente (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(180) NOT NULL)');
        $this->addSql('INSERT INTO attente (id) SELECT id FROM __temp__attente');
        $this->addSql('DROP TABLE __temp__attente');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_147659C95E237E06 ON attente (name)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_147659C95E237E06');
        $this->addSql('CREATE TEMPORARY TABLE __temp__attente AS SELECT id FROM attente');
        $this->addSql('DROP TABLE attente');
        $this->addSql('CREATE TABLE attente (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)');
        $this->addSql('INSERT INTO attente (id) SELECT id FROM __temp__attente');
        $this->addSql('DROP TABLE __temp__attente');
        $this->addSql('DROP INDEX IDX_7A5BC50599C4036B');
        $this->addSql('DROP INDEX IDX_7A5BC5058B71AC85');
